...
class Bookmark
  ...
  def self.all
    ...
    # Below we wrap each returned entry from our SQL search by making it into a new Bookmark instance
    # this means we can access it via the attr_reader and just call bookmark.title, etc.
